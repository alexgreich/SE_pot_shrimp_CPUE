...
M_10 <- lm(log(CPUE_nom+0.001) ~ Season.Ref * vessel_count_aa * ADFG.Number*Analysis.Area, data=D1) #fixef only with ALL the interaction effects
...
D1_new <- D1
D1_new$pred <- exp(predictions$fit[,1])-0.001
