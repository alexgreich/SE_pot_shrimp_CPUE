...
M_ranef <-  lmer(log(CPUE_nom+0.001) ~ Season.Ref + vessel_count_aa + Season.Ref:Analysis.Area + Analysis.Area + (1|ADFG.Number), data=D7, REML=F)
...
Need  impue values before the predict step. Also, test models again with impued values.
```{r}
